// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["bfzy","yzzy","ruyi","ikun","mdzy","hnzy","iqiyi","maoyan"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["bfzy","yzzy","ruyi","ikun","mdzy","hnzy","iqiyi","maoyan"];
                ...
                <div class="flex flex-wrap items-center justify-between mb-4 gap-2">
                    <div class="flex items-center gap-2">
                        <button onclick="toggleEpisodeOrder('${sourceCode}', '${id}')" 
                                class="px-3 py-1.5 bg-[#161b22] hover:bg-[#111827] border border-[#1f2937] rounded text-sm transition-colors flex items-center gap-1">
